<%@ page language="java" contentType="text/html; charset=GB18030"
    ...
    <jsp:useBean id="data" scope="page" class="b.JiuJingB" />
	...
	<div class="container">
		<div class="hero-unit">
			...
			<form class="navbar-form" >
				...
				<tr>
				<td align=center width="10%">发布者</td><td align=center width="65%">内容</td><td align=center width="15%">时间</td>
				</tr>
				<%
					while(rs.next())
					{											
