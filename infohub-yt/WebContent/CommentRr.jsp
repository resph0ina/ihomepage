		...
		<div class="hero-unit">
			...
			<form class="navbar-form" name="regist" action="CommentRr.jsp?rank=<%=request.getParameter("rank") %>" method="post">
				<table id="tb" class="datatb" cellspacing="0" width="100%" rules=all border frame=box>
				 <tr>
				 <td width="10%" align=center>评论人</td><td width="55%" align=center>内容</td><td width="20%" align=center>时间</td><td width="15%"></td>
				 </tr>
				...
				%>
					...
					<td align=center><input type="radio" name="com" value="<%=((Integer)i).toString()%>" />回复此评论</td>
					</tr>
				<%
						}
					}
				...
				<table>
					...
					<td><input type="radio" name="com" value="original" checked="checked"/>回复原内容</td>
					</tr>
					<tr>
