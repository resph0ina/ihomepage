		...
		<div class="hero-unit">
			...
			<form class="navbar-form" >
				<table id="tb" class="datatb" cellspacing="0" width="100%" rules=all border frame=box>
				 <tr>
				 <td width="90%" align=center>公告</td><td width="10%" align=center>时间</td>
				 </tr>
				<%
					while(rs.next())
					{				
	...
	<div class="container">
		<div class="hero-unit">
			...
			<form class="navbar-form" >
				<table id="tb" class="datatb" cellspacing="0" width="100%" rules=all border frame=box>
				<tr>
				<td align=center width="10%">发布者</td><td align=center width="65%">内容</td><td align=center width="15%">时间
				</tr>
				<%
					while(rs.next())
					{											
